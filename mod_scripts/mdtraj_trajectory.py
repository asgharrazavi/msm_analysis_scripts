...
#-------------------------------------------------------------------------------------------------------------------------
	...
	self.unitcell_vectors = self.unitcell_vectors[0:n_frames]						#ASGHAR
        with XTCTrajectoryFile(filename, 'w', force_overwrite=force_overwrite) as f:				#ASGHAR
...
# If you load a trajectory, t, and then modify its xyz coordinates, i.e. change t.xyz   
