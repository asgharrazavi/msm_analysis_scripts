...
def compute_rg(traj, atom_inds=None, masses=None):
    """Compute the radius of gyration for every frame.
    ...
    atom_inds : ndarray, optional
        array of atom indices for RG calculations
    ...
    if atom_inds == None : 
        ...
        return _compute_rg_xyz(traj.xyz[:,atom_inds,:], masses=masses)
